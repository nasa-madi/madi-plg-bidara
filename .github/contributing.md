...
Documentation is contained in Markdown files in the [docs](https://github.com/nasa-madi/madi-plg-bidara/docs) repository. To change the documentation submit a pull request to that repo, referencing any other PR if applicable, and the docs will be updated with the next release.
